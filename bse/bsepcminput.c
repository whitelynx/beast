			    ...
			    GParamSpec   *pspec)
{
  ...
  switch (param_id)
    ...
    case PARAM_MVOLUME_f:
      ...
      bse_object_param_changed (BSE_OBJECT (self), "gain_volume_dB");
      bse_object_param_changed (BSE_OBJECT (self), "gain_volume_perc");
      break;
    case PARAM_MVOLUME_dB:
      self->volume_factor = bse_dB_to_factor (sfi_value_get_real (value));
      bse_object_param_changed (BSE_OBJECT (self), "gain_volume_f");
      bse_object_param_changed (BSE_OBJECT (self), "gain_volume_perc");
      break;
