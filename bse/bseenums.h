...
typedef enum
{
  ...
  BSE_ERROR_BUSY		= GSL_ERROR_BUSY,
  BSE_ERROR_EXISTS		= GSL_ERROR_EXISTS,
  ...
  BSE_ERROR_NO_RESOURCE		= GSL_ERROR_NO_RESOURCE,
...
#define BSE_ERROR_FILE_EXISTS		BSE_ERROR_EXISTS
