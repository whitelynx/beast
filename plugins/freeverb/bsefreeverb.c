...
bse_free_verb_class_init (BseFreeVerbClass *class)
{
  ...
  bse_object_class_add_param (object_class, "Reverb Style",
			      PROP_ROOM_SIZE,
			      sfi_param_spec_real ("room_size", "Room Size", NULL,
  ...
  bse_object_class_add_param (object_class, "Reverb Style",
			      PROP_DAMPING,
			      sfi_param_spec_real ("damping", "Damping [%]", NULL,
  ...
  bse_object_class_add_param (object_class, "Reverb Style",
			      PROP_WET_LEVEL,
			      sfi_param_spec_real ("wet_level", "Wet Level [dB]", NULL,
  ...
  bse_object_class_add_param (object_class, "Reverb Style",
			      PROP_DRY_LEVEL,
			      sfi_param_spec_real ("dry_level", "Dry Level [dB]", NULL,
  ...
  bse_object_class_add_param (object_class, "Reverb Style",
			      PROP_WIDTH,
			      sfi_param_spec_real ("width", "Width [%]", NULL,
